INSERT INTO  customer (customer_id,name,fathers_name,address,password,nominee,email,phone) VALUES
  ('CUS03907364', 'Harry Potter', 'J K Rowling','Chennai','Customer@8743','Mother','customer@gmail.com',9345678094),
  ('CUS03950388', 'Boojith', 'Kathikeyan','Chennai','Customer@8345','Mother','boojith22@gmail.com',9500376088);
